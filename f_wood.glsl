...
void main(void) {
	...
	pixelColor = vec4(sunLightColor * sun_nl * kd.rgb, kd.a) + attenuation * vec4(lamp_nl * kd.rgb, kd.a) + vec4(sunLightColor * ks.rgb * sun_rv, 0) + attenuation * vec4(ks.rgb * lamp_rv, 0);
